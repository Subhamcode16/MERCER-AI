...
- product knowledge
- audience knowledge
- statistical patterns (data-driven)
- expert patterns (human-curated aesthetic logic)
...
Decision Evaluation (Constraint Solver)

Every alternative is evaluated by the **Image Formation Intelligence** sub-engine.
This engine solves a constraint optimization problem rather than applying static rules.

It evaluates interactions such as:
- Material × Lighting
- Pose × Garment
- Brand × Atmosphere

It evaluates constraints against:
Business
Brand
Audience
Narrative
