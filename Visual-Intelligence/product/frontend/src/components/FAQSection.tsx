...
export function FAQSection() {
  ...
  return (
    <section className="w-full py-12 md:py-16 px-6 md:px-12 bg-transparent border-t border-border relative z-10">
      <div className="max-w-4xl mx-auto w-full flex flex-col gap-12">
        ...
        <div className="flex flex-col gap-2 text-center items-center">
          ...
          <h2 className="text-3xl font-serif tracking-wide text-foreground font-light">
          ...
          {FAQ_ITEMS.map((item, idx) => {
            ...
            return (
              <div
                key={idx}
                className={cn(
                  "border border-border hover:border-primary/40 rounded-2xl bg-card transition-all duration-300 overflow-hidden shadow-xs",
                  isOpen && "border-primary/50 bg-card shadow-sm"
                )}
              >
                {/* Accordion Trigger */}
                <button
                ...
                >
                  <span className="text-[13px] font-sans font-medium tracking-wide text-foreground transition-colors">
                    {item.question}
                  </span>
                  <ChevronDown
                    size={16}
                ...
                >
                  <div className="overflow-hidden">
                    <p className="px-6 pb-6 pt-1 text-[12px] font-sans text-muted-foreground leading-relaxed font-normal">
                      {item.answer}
                    </p>
                  </div>
                </div>
