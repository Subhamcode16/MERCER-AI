      ...
      <div className="rounded-[11px] bg-[#0d0d0d] p-8 flex flex-col gap-8">
        ...
        <div className="flex gap-5">
          ...
          <div className="flex flex-col gap-2.5">
            <span className="text-[10px] text-white/40 uppercase tracking-[0.2em] font-medium">VYREN Copilot</span>
        ...
        <div className="relative mt-2">
          <input 
            type="text" 
            placeholder="Ask VYREN anything... (e.g. Generate a moodboard based on Direction 01)" 
