...
# Ontology Hierarchy: Base vs Extension

The platform understands reality through a two-layered hierarchical abstraction: **The Universal Ontology** (Base) and the **Domain Ontology** (Extension).

## 1. The Universal Ontology (Base)
This layer contains concepts that exist in *every* image, regardless of the industry.
- Lighting, Composition, Camera, Color, Mood, Depth, Perspective.
- Agnostic to whether the image is of a Saree, a Skyscraper, or a Sports Car.

## 2. The Domain Ontology (Extension)
This layer extends the Universal base into specific, proprietary industries.
- *Fashion Extension:* Saree, Lehenga, Fabric, Drape, Silhouette.
- *Architecture Extension:* Facade, Material, Roof.

Both layers combine to define the total Knowledge Space for a session.

```text
Platform
  ↓
Universal Ontology (VIO-005) + Domain Ontology (VIO-006)
  ↓
Entities
  ↓
Attributes
